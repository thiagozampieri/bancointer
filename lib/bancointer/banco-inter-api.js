...
var BancoInterAPI = /*#__PURE__*/ (function () {
  ...
  (0, _createClass2["default"])(BancoInterAPI, [
      ...
      value: (function () {
        var _get = (0, _asyncToGenerator2["default"])(
          /*#__PURE__*/ _regenerator["default"].mark(
            function _callee(path, queryParams) {
              var _context;
                  ...
                  while (1) {
                    switch ((_context2.prev = _context2.next)) {
                      ...
                      case 2:
                        ...
                        throw new _responseError.ResponseError(
                          response.data.detail,
                          response.data.violacoes,
                          response.status,
                        );
                ...
                function _callee4$(_context8) {
                  while (1) {
                    switch ((_context8.prev = _context8.next)) {
                      case 0:
                        _context8.next = 2;
                        return _axios["default"].patch(
                          (0, _concat["default"])(
                            (_context7 = "".concat(this.baseUrl, "/")),
                          ).call(_context7, path),
                          data,
                          this.config(),
                        );
    ...
    },
    {
      key: "setAcessToken",
      value: (function () {
        var _setAcessToken = (0, _asyncToGenerator2["default"])(
          /*#__PURE__*/ _regenerator["default"].mark(
            function _callee5(accessToken) {
              return _regenerator["default"].wrap(
                function _callee5$(_context9) {
                  while (1)
                    switch ((_context9.prev = _context9.next)) {
                      case 0:
                        console.log(
                          "🚀  ~ BancoInterAPI ~ setAcessToken ~ accessToken:",
                          accessToken,
                        );
    ...
    },
    {
      ...
      value: function headers() {
        console.log(
          "🚀  ~ BancoInterAPI ~ headers ~ accessToken:",
          this.accessToken,
        );
        if (!this.accessToken) {
          throw new _responseError.ResponseError(
