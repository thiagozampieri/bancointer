...
var BancoInterAPI = /*#__PURE__*/function () {
  function BancoInterAPI(conta, cert, key, ca, clientId, clientSecret, environment) {
  ...
  (0, _createClass2["default"])(BancoInterAPI, [{
    ...
    key: "setAcessToken",
    value: function () {
      var _setAcessToken = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee5(accessToken) {
        return _regenerator["default"].wrap(function _callee5$(_context9) {
          while (1) switch (_context9.prev = _context9.next) {
            case 0:
              console.log("🚀  ~ BancoInterAPI ~ setAcessToken ~ accessToken:", accessToken);
      ...
      function setAcessToken(_x9) {
        return _setAcessToken.apply(this, arguments);
      }
    ...
    key: "connect",
    value: function () {
      var _connect = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee6() {
        var _context10;
        ...
        return _regenerator["default"].wrap(function _callee6$(_context11) {
          while (1) switch (_context11.prev = _context11.next) {
            case 0:
              ...
              _context11.next = 4;
              return _axios["default"].post((0, _concat["default"])(_context10 = "".concat(this.baseUrl, "/")).call(_context10, path), data, {
            ...
            case 7:
              console.log("🚀  ~ BancoInterAPI ~ connect ~ response.data:", response.data);
    ...
    value: function headers() {
      console.log("🚀  ~ BancoInterAPI ~ headers ~ accessToken:", this.accessToken);
      if (!this.accessToken) {
        throw new _responseError.ResponseError('missing_access_token', [], 500);
      }
      return {
